function CambioTexto(){
    let e=document.getElementsByClassName("todo");
...
function displayPhrase() {
    if (currentPhraseIndex < phrases.length) {
        ...
        phraseElement.textContent = '¡Has completado todo el formulario!';
...
submitButton.addEventListener('click', () => {
    ...
    if (userInput === correctPhrase) {
        ...
        messageElement.textContent = `Te equivocaste! pero no te preocupes. La respuesta correcta era: "${correctPhrase}"`;
